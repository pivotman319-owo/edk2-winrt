...
################################################################################
[Defines]
  PLATFORM_NAME                  = ArmVirtQemuWinRt
  PLATFORM_GUID                  = 7e0b2300-9a47-42fc-b346-b34d23025b69
  PLATFORM_VERSION               = 0.1
  DSC_SPECIFICATION              = 0x00010005
  OUTPUT_DIRECTORY               = Build/ArmVirtQemuWinRt-$(ARCH)
  SUPPORTED_ARCHITECTURES        = ARM
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = ArmVirtPkg/ArmVirtQemuWinRt.fdf
...
[BuildOptions]
  RVCT:*_*_ARM_PLATFORM_FLAGS == --cpu Cortex-A9 -I$(WORKSPACE)/ArmVirtPkg/Include
  GCC:*_*_ARM_PLATFORM_FLAGS == -mcpu=cortex-a9 -I$(WORKSPACE)/ArmVirtPkg/Include
...
!endif
  ...
  gArmVirtWinRtTokenSpaceGuid.PcdPlatformEhciSize|0x00020000
